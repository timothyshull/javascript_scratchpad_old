...
/***/ function(module, exports, __webpack_require__) {
	...
	var _routerJs = __webpack_require__(6);

	var _routerJs2 = _interopRequireDefault(_routerJs);

	var _viewsAppViewJs = __webpack_require__(9);

	var _viewsAppViewJs2 = _interopRequireDefault(_viewsAppViewJs);

	var App = function App() {
	    _classCallCheck(this, App);

	    this.AppRouter = new _routerJs2["default"]();
	    this.AppView = new _viewsAppViewJs2["default"]();
	    this.AppView.render();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _viewsBaseViewJs = __webpack_require__(7);

	var _viewsBaseViewJs2 = _interopRequireDefault(_viewsBaseViewJs);
	...
	var AppRouter = (function (_Backbone$Router) {
	    ...
	    function AppRouter(options) {
	        ...
	        _get(Object.getPrototypeOf(AppRouter.prototype), "constructor", this).call(this, options);
	        this._bindRoutes();
	    }
	    ...
	    _createClass(AppRouter, [{
	        ...
	        value: function initialize() {
	            (0, _jquery2["default"])(".app-content").append("<div>Test is working</div>");
	        }
	    }, {
	        key: "main",
	        value: function main() {
	            var baseView = new _viewsBaseViewJs2["default"]();
	            baseView.render();
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _templatesBaseTplJs = __webpack_require__(8);

	var _templatesBaseTplJs2 = _interopRequireDefault(_templatesBaseTplJs);

	exports["default"] = _backbone2["default"].View.extend({
	    el: ".main",
	    template: _lodash2["default"].template(_templatesBaseTplJs2["default"]),
	    render: function render() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _templatesAppTplJs = __webpack_require__(10);

	var _templatesAppTplJs2 = _interopRequireDefault(_templatesAppTplJs);

	var _templatesHeaderTplJs = __webpack_require__(11);

	var _templatesHeaderTplJs2 = _interopRequireDefault(_templatesHeaderTplJs);

	var _templatesFooterTplJs = __webpack_require__(12);

	var _templatesFooterTplJs2 = _interopRequireDefault(_templatesFooterTplJs);
	...
	var AppView = (function (_Backbone$View) {
	    ...
	    function AppView() {
	        ...
	        this.setElement((0, _jquery2["default"])(".app-content"), true);
	        this.$main = this.$(".main");
	        this.$header = this.$(".header");
	        this.$footer = this.$(".footer");
	        this.headerTemplate = _lodash2["default"].template(_templatesHeaderTplJs2["default"]);
	        this.footerTemplate = _lodash2["default"].template(_templatesFooterTplJs2["default"]);
	    }
