(function () {
    ...
    function n(a) {
        ...
        if (this.e)for (a = 0, c = this.e.length; a < c; a++)0 > this.g.indexOf(this.e[a]) && this.b([this.c + "_cookiePathCopy", this.e[a]]);
        ...
        q(document.body, "click", function (a) {
            ...
            do {
                ...
                if (Boolean("a" == b.nodeName.toLowerCase() || b.getAttribute("data-g-event") || b.getAttribute("data-g-action") || b.getAttribute("data-g-label"))) {
                    var b = u(this, "eventname", a), d = u(this, "action", a), e = u(this, "label", a);
                    this.f(b, d, e)
                }
    ...
    function p(a, c, b) {
        ...
        if (document.addEventListener)try {
            ...
            q(window, "load", c, a)
        } else if (!document.uniqueID && document.expando)var e = document.createElement("tempnode"), k = window.setInterval(function () {
            try {
                e.doScroll("left")
            } catch (a) {
                return
            ...
            b && (c = m(c, b));
            c()
        }, 50); else"readyState" in document ? k = window.setInterval(function () {
